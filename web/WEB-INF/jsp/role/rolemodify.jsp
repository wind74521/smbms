...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
    <div class="right">
        ...
        <form id="roleForm" name="roleForm" method="post" action="${pageContext.request.contextPath }/role/updateSave">
			<input type="hidden" name="id" value="${role.id }"/>
			 <div>
                    <label for="roleCode">用户编码：</label>
                    <input type="text" id="roleCode" name="roleCode" value="${role.roleCode }" readonly="readonly">
             </div>
			 <div>
